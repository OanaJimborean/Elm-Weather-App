...
import Util
import Util.Time
import View.WeatherChart exposing (..)
...
getChartData chartWeather =
    let
        now = chartWeather.time
        tempMin = chartWeather.weather  |> WeatherData.toHourlyDataPoints |> Util.minimumBy .temperature
        tempMax = chartWeather.weather |> WeatherData.toHourlyDataPoints |> Util.maximumBy .temperature
        hourlyDataPoints = chartWeather.weather |> WeatherData.toHourlyDataPoints
        hovering = []
        itemsToShow = View.WeatherChart.showAllItems
    in
        View.WeatherChart.ChartData now tempMin tempMax hourlyDataPoints hovering itemsToShow
